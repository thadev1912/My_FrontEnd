                          ...
                          <div class="card-header bg-primary text-white">
                           ...
                           <table class="table  ">
                                     <thread >
                                           ...
                                           <th align="center"><a class="" href="{!! URL::route('thembaiviet') !!}">Thêm Bài Viết</a>    </th>
                                     ...
                                     <tbody>
                                      @foreach ($baiviet as $bv)
                                         <tr>
                                             ...
                                             <td>{{$bv->id}}</td>
                                             <td>{{$bv->title}}</td>
                                             <td>{!! Illuminate\Support\Str::limit($bv->noidung, 150, $end='...') !!}</td>
                                             <td><img src="../public/img/images/{{$bv->hinh}}" style="width:70px;height:70px;"></td>
                                             <td class="td-actions">
                        <a href="{!! URL::route('suabaiviet', $bv->id) !!}" class="  btn-xs btn-primary"><i class="btn-icon-only icon-edit">Sửa</i></a>

                        <a href="{!! URL::route('xoabaiviet', $bv->id) !!}" class="  btn-xs btn-danger">
