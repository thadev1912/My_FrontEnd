...
<div class="card-body">
            ...
            <form action="{!! URL::route('capnhatbaiviet', $tdx->id) !!}" method="POST" enctype='multipart/form-data'>
            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
            <div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        <label>Tiêu đề bài viết</label>
                        <input id="current-pass-control" name="txt_title" class="form-control" type="text" value="{!!$tdx->title !!}">
                        <div>
...
<div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                   <div class="col">
                        ...
                        <textarea id="editor" name="txt_noidung" class="form-control" type="text"> {!!$tdx->noidung !!}</textarea>
                        <div>
