...
<div class="card-body">
            ...
            <form action="{!! URL::route('capnhatbaivietthitruong', $ttt->id) !!}" method="POST" enctype='multipart/form-data'>
            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
            <div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        <label>Tiêu đề bài viết</label>
                        <input id="current-pass-control" name="txt_title" class="form-control" type="text" value="{!!$ttt->title !!}">
                        <div>
...
<div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                   <div class="col">
                        ...
                        <textarea id="editor" name="txt_noidung" class="form-control" type="text"> {!!$ttt->noidung !!}</textarea>
                        <div>
...
<div class="form-row"> 
                    <div class="col">
                        <label>HagTag</label>
                        <input data-role="tagsinput" id="current-pass-control" name="txt_hagtag" class="form-control" type="text" value="{!!$ttt->tag !!}">
                        <div>
                                    {!! $errors->first('txt_title') !!}
                                </div>
                    </div>
...
<div class="form-row"> 
      ...
      <div class="preview">
                <img id="img-preview"  src="../img/images/{{$ttt->hinh}}" />
                <label class="btn btn-primary" for="file-input"> Thay Thế Ảnh Đại Diện Mới</label>
