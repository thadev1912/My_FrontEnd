      ...
      <div class="col-5">
        <div class="card shadow-2-strong" style="border-radius: 1rem;">
          <div class="card-body text-center">
            ...
            <h3 class="mb-5 text-danger">ĐĂNG NHẬP</h3>
            @if(Session::has('thongbao'))
                      ...
                      @endif
            <div class="form-row ">
                    <div class="col-md-4 mt-3 font-italic ">
  ...
  <br>
     ...
     <br>
      -->
            ...
            <button class="btn btn-danger btn-lg btn-block" type="submit" name="submit">XÁC NHẬN</button>
