...
<div class="card-body">
            ...
            <form action="{!! route('luumon') !!}" method="POST">
            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
            <div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        <label>Mã Môn</label>
                        <input id="current-pass-control" name="txtma_mon" class="form-control" type="text" value="{!! old('txtmakh') !!}">
                                <div>
...
<div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                   <div class="col">
                        <label>Tên Môn</label>
                        <input id="new-pass-control" name="txtten_mon" class="form-control" type="text" value="{!! old('txttenkh') !!}">
                                <div>
                                    {!! $errors->first('txtma_mon') !!}
                                </div>
                    </div>
...
<div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                   <div class="col">
                        ...
                        <input id="new-pass-control" name="txttin_chi" class="form-control" type="text" value="{!! old('txttenkh') !!}">
                                <div>
