...
<div class="card-body">
            ...
            <div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        ...
                        <input id="current-pass-control" name="txtMa" class="form-control" type="text" value="{!! $data->masv !!}">
                                <div>
                                    {!! $errors->first('txtMa') !!}
                                </div>
                    </div>
                   <div class="col">
                        ...
                        <input id="new-pass-control" name="txtTen" class="form-control" type="text" value="{!! $data->tensv !!}">
                                <div>
                                    {!! $errors->first('txtTen') !!}
                                </div>
                    </div>
...
<div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        ...
                        <input id="current-pass-control" name="txtgioitinh" class="form-control" type="text" value="{!! $data->gioitinh !!}">
                                <div>
                   ...
                   <div class="col">
                        ...
                        <input id="new-pass-control" name="txtpban" class="form-control" type="text" value="{!! $data->pban !!}">
                                <div>
...
<div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        ...
                        <input id="current-pass-control" name="txtns" class="form-control" type="text" value="{!! $data->noisinh !!}">
                                <div>
                                    {!! $errors->first('txtns') !!}
                                </div>
                    </div>
