...
<div class="card-body">
            ...
            <div class="form-row"> <!--thuộc tính form-row nó giúp chia 2 cột trên 1 row của nó-->
                    <div class="col">
                        ...
                        <input id="current-pass-control" name="txtmakh" class="form-control" type="text" value="{!! old('txtmakh') !!}">
                                <div>
                   ...
                   <div class="col">
                        ...
                        <input id="new-pass-control" name="txttenkh" class="form-control" type="text" value="{!! old('txttenkh') !!}">
                                <div>
